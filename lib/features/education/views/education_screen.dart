...
class _EducationScreenState extends ConsumerState<EducationScreen> {
  ...
  void _navigateToAllArticles() {
    context.push(RouteNames.allArticles).then((_) {
      ref.invalidate(educationListProvider);
      ref.invalidate(savedArticlesProvider);
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final bookmarkedArticles =
        savedArticlesAsync.value ??
        allArticles.where((a) => a.isBookmarked).toList();
    ...
    final filteredArticles =
        allArticles.where((article) {
          final matchesQuery =
              ...
              (article.quoteText.toLowerCase().contains(
                _searchQuery.toLowerCase(),
              ));
    ...
    final EducationArticle? featured =
        allArticles.isNotEmpty ? allArticles.first : null;
