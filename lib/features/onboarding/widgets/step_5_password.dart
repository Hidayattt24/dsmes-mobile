...
class Step5Password extends ConsumerStatefulWidget {
  const Step5Password({super.key});

  @override
  ConsumerState<Step5Password> createState() => _Step5PasswordState();
}

class _Step5PasswordState extends ConsumerState<Step5Password> {
  bool _obscure = true;
