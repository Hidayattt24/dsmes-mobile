...
class BloodSugarEditSheet extends StatefulWidget {
  ...
  final void Function(String value, String moment, String time, String status)?
  onSaved;
...
class _BloodSugarEditSheetState extends State<BloodSugarEditSheet> {
  ...
  final List<String> _times = ['07:00', '07:30', '11:30', '18:00', '21:00'];
                    ...
                    children:
                        _moments.map((moment) {
                          ...
                          return ChoiceChip(
                            ...
                            onSelected: (selected) {
                              if (selected)
                                setState(() => _selectedMoment = moment);
                            },
                          );
                        }).toList(),
                  ),
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              'Catatan gula darah "$val mg/dL" berhasil diperbarui',
                            ),
...
Future<void> showBloodSugarEditSheet(
  ...
  void Function(String value, String moment, String time, String status)?
  onSaved,
}) {
