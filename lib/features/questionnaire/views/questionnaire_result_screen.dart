  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          isPreTest ? 'Hasil Pre-Test' : 'Hasil Post-Test',
                        ...
                        child: RichText(
                          text: TextSpan(
                            ...
                            children: [
                              ...
                              TextSpan(
                                text: isPassed
                                    ? 'Pengetahuan Anda sangat baik. '
                                        'Anda dapat mempelajari materi lain atau mengulang Post-Test kapan saja.'
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'Pre-Test selesai! Hasil ini dicatat dan tidak perlu diulang.',
                            style: AppTextStyles.bodyMd.copyWith(
                              fontSize: 13,
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  // Button: Lihat Pembahasan Jawaban
                  SizedBox(
                    width: double.infinity,
                    height: 48,
                  ...
                  // Button: Kerjakan Ulang Post-Test (Only for Post-Test)
                  if (!isPreTest) ...[
                    SizedBox(
                      width: double.infinity,
                      height: 48,
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      label: Text(
                        isPreTest ? 'Lanjut ke Beranda' : 'Kembali',
                        style: AppTextStyles.poppinsButton.copyWith(
                          fontWeight: FontWeight.bold,
                          fontSize: 14,
                          color: Colors.white,
